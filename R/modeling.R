...
#' Plot category boundaries with error linerange
#'
#' @param cat_bounds As generated by category_boundaries
#' @param dodge_w How much to dodge different conditions by
#'
#' @export
